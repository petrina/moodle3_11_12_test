...
$string['configfrontpagemanager'] = 'The items selected above will be displayed on the site\'s front page for role managet.';
$string['configfrontpageeditingteacher'] = 'The items selected above will be displayed on the site\'s front page for role editingteacher.';
$string['configfrontpagestudent'] = 'The items selected above will be displayed on the site\'s front page for role student.';
...
$string['frontpagemanager'] = 'Front page for manager';
$string['frontpageeditingteacher'] = 'Front page for editingteacher';
$string['frontpagestudent'] = 'Front page for student';
