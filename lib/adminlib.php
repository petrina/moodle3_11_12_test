...
class admin_setting_courselist_frontpage_by_role extends admin_setting
{
    /** @var array Array of choices value=>label */
    public $choices;
    ...
    public function __construct($role) {
        ...
        require_once($CFG->dirroot.'/course/lib.php');
        $name        = 'frontpage'.$role;
        $visiblename = get_string('frontpage'.$role,'admin');
        $description = get_string('configfrontpage'.$role,'admin');
        $defaults    = array(FRONTPAGEALLCOURSELIST);
        parent::__construct($name, $visiblename, $description, $defaults);
    }
